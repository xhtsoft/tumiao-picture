package com.xhtsoft.tumiaopicturebackend.manager.auth;
...
import static com.xhtsoft.tumiaopicturebackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    /**
     * 返回一个账号所拥有的角色标识集合 (权限与角色可分开校验)，本项目使用权限校验，此处返回空集合
     */
    @Override
    ...
    private SpaceUserAuthContext getAuthContextByRequest() {
        ...
        if (ContentType.JSON.getValue().equals(contentType)) {
            ...
            Map<String, String> parMap = ServletUtil.getParamMap(request);
            authContext = BeanUtil.toBean(parMap, SpaceUserAuthContext.class);
        }
        // 根据请求路径区分id字段的含义
